import { ListStorageLocationsController } from '@app/application/controllers/location/list-storage-locations.controller'
import { ListStorageLocationsUseCase } from '@app/application/usecases/location/list-storage-locations.usecase'

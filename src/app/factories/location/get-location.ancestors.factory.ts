import { GetLocationAncestorsController } from '@app/application/controllers/location/get-location-ancestors.controller'
import { GetLocationAncestorsUseCase } from '@app/application/usecases/location/get-location-ancestors.usecase'
